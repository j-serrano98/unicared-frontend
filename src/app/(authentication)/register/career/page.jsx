import SelectCareer from "@/app/components/registration-step-by-step/SelectCareer";
            ...
            <div className="mx-auto max-w-screen-xl p-10 bg-gray-900">
                ...
                <div className="">
                    ...
                    <form action="#" className="w-full space-y-6 lg:space-y-8">
                        ...
                        <div className="flex">
                            <SelectCareer careers={careersData}/>
                        </div>
