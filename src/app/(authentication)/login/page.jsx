...
export default function LoginPage() {
    ...
    return(
        <div className="bg-gray-900 h-full flex items-center">
                    <div className="container flex justify-between items-center py-16 mx-auto px-2 md:px-16">
                        <div className="hidden md:block">
                            <div className="mb-8 flex space-x-3 rtl:space-x-reverse">
                                ...
                                <div>
                                    <span className="text-white font-semibold text-2xl block">Regístrate rápidamente</span>
                            ...
                            <div className="mb-8 flex space-x-3 rtl:space-x-reverse">
                                ...
                                <div>
                                    <span className="text-white font-semibold text-2xl block">Registra tu progreso académico</span>
