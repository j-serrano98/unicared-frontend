    ...
    return (
        <section className="bg-blue-50 px-4 py-6">
            <div className='container-xl lg:container m-auto'>
                <h2 className='text-3xl font-bold text-center pb-6 text-indigo-500'>
                    Top Profesores
                </h2>
                { loading ? (
                    ...
                    <div className="flex gap-6">
                      {teachers.map((teacher) => {
                        ...
                        return(
                            <div key={teacher.id} className="w-full max-w-sm bg-gray-900 text-white p-6 border border-default rounded-base shadow-xs rounded-xl">
                                <div>
                                    <div className="flex -between space-x-3 mb-6">
                                        <div className="flex items-center space-x-1 rtl:space-x-reverse">
                                            {
