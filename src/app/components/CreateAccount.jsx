                    ...
                    <div className="p-6 space-y-2">
                        ...
                        <form className="space-y-4 md:space-y-6" action={formAction}>
                            ...
                            <div>
                                ...
                                <input type="email" name="email" id="email" className="border text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" placeholder="jose.perez@unicaribe.edu.do" required/>
                            </div>
                            <div>
                            ...
                            <div>
                                <label htmlFor="confirm-password" className="block mb-2 text-sm font-medium text-white">Confirmar Contraseña</label>
                                <input type="password" name="confirm-password" id="confirm-password" placeholder="••••••••" className="border text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" required/>
                            </div>
                            ...
                            <button className={`w-full text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 bg-blue-600 hover:bg-blue-700 hover:cursor-pointer dark:focus:ring-blue-800`}>Crear cuenta</button>
                            <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                Ya tienes una cuenta? <a href="/login/" className="font-medium text-blue-600 hover:underline dark:text-blue-500">Inicia sesión</a>
                            </p>
                        </form>
                    </div>
                </div>
