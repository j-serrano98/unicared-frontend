    ...
    return (
        <div className="w-full max-w-sm p-4 sm:p-6 bg-neutral-primary-soft border border-default rounded-base shadow-xs rounded-lg">
                ...
                <ul className="my-6 space-y-3">
                    <li>
                        <a href="https://chat.whatsapp.com/IZgI4wawIrD8JvDQx4NlBp" className="flex items-center p-3 text-lg font-semibold text-heading rounded-base bg-neutral-secondary-medium hover:bg-neutral-tertiary-medium group">
