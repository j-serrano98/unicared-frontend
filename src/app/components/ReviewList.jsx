...
export default function ReviewList({ teacherData }) {
    ...
    return(
        <div className="antialiased dark:bg-gray-900 py-6 ps-6 pe-2 rounded-base rounded-2xl">
            <section>
                <div className="mx-auto max-w-screen-xl px-4 2xl:px-0 h-[76vh] overflow-hidden overflow-y-auto scrollbar">
                    ...
                    <div className="mt-2 flex items-center gap-2 sm:mt-0">
                        ...
                        <p className="text-sm font-medium leading-none text-gray-500 dark:text-gray-400">({(teacherData.reviews.reduce((acc, curr) => acc + curr.average, 0) / teacherData.reviews.length || 0).toFixed(2)})</p>
                        <a href="#" className="text-sm font-medium leading-none text-gray-900 underline hover:no-underline dark:text-white"> {teacherData.reviews.length} Reviews </a>
                    </div>
                    </div>
                        ...
                        return(
                            <div key={i} className={`gap-3 ${i == 0 ? 'pb-6' : 'py-6'} sm:flex sm:items-start pe-3`}>
                                ...
                                {/* <div className="flex items-center gap-4">
                                    ...
                                    <label htmlFor="reviews-radio-1" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Si: 3 </label>
                                    </div>
                                    <div className="flex items-center">
